...
import (
	...
	http2 "application-web/pkg/utils/http"
	"archive/zip"
	"bufio"
	"context"
	"fmt"
...
// 			logger.Error("save cache error, err %s", err.Error())
// 		}
// 	} else {
...
// 	if err != nil {
// 		logger.Error("get download file [%s] error, err %s", dst, err.Error())
// 		return err
// 	}
// 	out, err := os.Create(dst)
// 	if err != nil {
// 		logger.Error("create download file [%s] error, err %s", dst, err.Error())
// 		return err
// 	}
// 	go func() {
...
// 			logger.Error("save download file [%s] error, err %s", dst, err.Error())
// 		}
// 		out.Close()
// 		resp.Body.Close()
...
// 		if err != nil {
// 			logger.Error("get cache error,err %s", err.Error())
// 			return
// 		}
// 		process := &Process{}
