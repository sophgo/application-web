  ...
  <el-card style="margin: 10px 10px">
    <el-form :inline="true" class="form">
      <el-form-item label="任务">
        <el-select v-model="reqItem.taskId" clearable filterable placeholder="请选择">
          <el-option v-for="item in taskIds" :key="item" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="视频通道">
        <el-select v-model="reqItem.srcId" clearable filterable placeholder="请选择">
          <el-option v-for="item in srcIds" :key="item" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="算法">
        <el-select v-model="reqItem.types" multiple placeholder="请选择">
          <el-option v-for="item in types" :key="item" :label="getNameByType(item)" :value="item" />
        </el-select>
      </el-form-item>
...
import { reqAlarmList, getInfo, reqDeleteAlarm } from '@/api/algo/alarm'
import type { ResAlarmList, AlarmRes, ResInfo, ReqData, AlarmItem, Box } from '@/api/algo/alarm/type'
import type { ResAbilityList, AbilityList } from '@/api/algo/task/type'
import { getAbilites } from '@/api/algo/task'
