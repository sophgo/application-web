      ...
      <el-card style="margin: 10px 10px">
        ...
        <el-form :inline="true" class="form">
          ...
          <el-form-item style="float: right; text-align: right">
            <el-button type="primary" size="default" @click="addSearchTask">搜索</el-button>
...
import { reqAlarmList, getInfo, reqDeleteAlarm, reqSearchResList, reqAddSearchTask } from '@/api/face/search'
import type { ResAlarmList, AlarmRes, ResInfo, ReqData, AlarmItem, Box, SearchReqData, SearchResReq,} from '@/api/face/search/type'
